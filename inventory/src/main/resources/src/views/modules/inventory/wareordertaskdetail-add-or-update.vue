<template>
  <el-dialog
    ...
    <el-form-item label="1锁定 2解锁 3已扣减" prop="lockStatus">
      <el-input v-model="dataForm.lockStatus" placeholder="1锁定 2解锁 3已扣减"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          lockStatus: [
            { required: true, message: '1锁定 2解锁 3已扣减不能为空', trigger: 'blur' }
          ]
        }
      }
    },
